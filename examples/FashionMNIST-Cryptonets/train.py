...
def main(_):
    ...
    # Create the model
    x = tf.placeholder(tf.float32, [None, 784], name='inx')
    y_ = tf.placeholder(tf.float32, [None, 10], name='iny')
    ...
    accuracy = tf.reduce_mean(correct_prediction, name='theend')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        # default='/home/ron/data/fashion-mnist/data/fashion',
